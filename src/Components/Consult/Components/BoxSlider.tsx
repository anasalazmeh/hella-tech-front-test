  ...
  return (
    <div className="box ">
      ...
      <div className=" flex justify-center items-center flex-col bg-[#0D1C22]">
        ...
        <button onClick={()=>navigate("consult-now/1")} className='w-1/2 max-w-[216.4px] h-[29.79px] border-[1px] border-solid border-[#28ea86] rounded-[10px] m-5 mt-1 bg-white'>Consult Now</button>
      </div>
    </div>
  )
}
