  ...
  return (
    <div className="">
      <div className="flex mt-3">
        <div className="w-[40%] ">
        <img src={data?.image} alt="" className="w-full md:h-full" />
        </div>
        <div className="w-[60%] bg-[#F4F4F4] p-2 md:p-5">
          <div
          ...
          >
            ...
            <p className="text-[8px] md:text-[36px] mb-1 font-bold">
              {data?.translations.specialization[i18n.language]}
            </p>
          </div>
          <p className="leading-[12.7px] sm:text-[14px] sm:leading-[19.04px] text-[9px] md:leading-[47.04px] my-1 md:my-5 md:mt-9  md:text-[32px] font-[400]">
